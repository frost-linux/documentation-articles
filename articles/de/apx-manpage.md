...
```md
`apx` - Der nutzerfreundliche Frost OS-Paketverwalter mit Unterstützung für die Installation von Paketen aus verschiedenen Quellen in Containern, um das Root-Dateisystem nicht zu verändern.
```
...
```md
Mitwirkende von Frost OS
```

## FEHLER MELDEN

Fehler bitte beim [Bugtracker](https://github.com/Frost-OS/apx/issues) melden.
