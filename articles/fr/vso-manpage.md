...
```md
VSO est un utilitaire qui vous permet de réaliser des taches de maintenance sur votre installation Frost OS.
```
...
```md
Les contributeurs de Frost OS, dont D-Maxwell (traducteur)
```

## SIGNALER DES BUGS

Signalez des bugs sur le [recenseur de problèmes](https://github.com/Frost-OS/vanilla-system-operator/issues).
