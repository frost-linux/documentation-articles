---
Title: Page de manuel (manpage) pour apx - Frost OS
...
```md
Contributeurs de Frost OS
Traduit en français par aWildJumpyGame
```

## SIGNALER DES BOGUES

Signaler un bogue au [traqueur de problèmes](https://github.com/Frost-OS/apx/issues).
