...
```md
apx - простий у використанні менеджер пакунків Frost OS з підтримкою встановлення пакунків з декількох джерел
...
Повідомляйте про баги на [трекері помилок](https://github.com/Frost-OS/apx/issues).
