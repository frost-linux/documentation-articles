---
Title: Менеджер пакунків (apx) - Frost OS
Description: Дізнайтеся, як користуватися apx, менеджером пакунків Frost OS.
...
`apx` - це простий у використанні менеджер пакунків Frost OS з підтримкою встановлення пакунків з різних джерел всередині контейнерів без зміни кореневої файлової системи.
...
22.10 для Frost OS 22.10) і обгортає всі команди у Ваш менеджер пакунків (`apt` для Ubuntu).
